    ...
    def main(self):
        ...
        while True:
            ...
            for i, pt in enumerate(pts):
                self.frame = draw_points_and_skeleton(self.frame, pt, joints_dict()[self.args.hrnet_joints_set]['skeleton'], person_index=i,
            ...
            if not start:
                ...
                cv2.putText(self.frame, self.text_ready, (50,50), cv2.FONT_HERSHEY_PLAIN, 2.0, (0, 0, 255), 2)
                angel = self.cal_angle(pts, 'start')
                start = True if angel <= 5 else False
    
            if start:
                self.text_elbow_touch_knee = 'please elbow touch knee'
                cv2.putText(self.frame, self.text_elbow_touch_knee, (50, 50), cv2.FONT_HERSHEY_PLAIN, 2.0, (0, 0, 255), 2)
            ...
            if has_display:
                ...
                if angle <= 50 and start:
                    ...
                    cv2.putText(self.frame, self.text_error, (330, 50), cv2.FONT_HERSHEY_PLAIN, 2.0, (0, 0, 255), 2)

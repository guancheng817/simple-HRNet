...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        # self.sew = QtWidgets.QLineEdit(Dialog)
        # self.sew.setGeometry(QtCore.QRect(150, 60, 71, 26))
        # self.sew.setObjectName("lineEdit_2")
        # self.raise_feet = QtWidgets.QLineEdit(Dialog)
        # self.raise_feet.setGeometry(QtCore.QRect(290, 60, 71, 26))
        # self.raise_feet.setObjectName("lineEdit_3")
        # self.hks = QtWidgets.QLineEdit(Dialog)
        # self.hks.setGeometry(QtCore.QRect(70, 180, 91, 26))
        # self.hks.setObjectName("lineEdit_4")
        # self.ratio_distance = QtWidgets.QLineEdit(Dialog)
        # self.ratio_distance.setGeometry(QtCore.QRect(230, 180, 81, 26))
        # self.ratio_distance.setObjectName("lineEdit_5")
        # self.label = QtWidgets.QLabel(Dialog)
        # self.label.setGeometry(QtCore.QRect(40, 90, 41, 21))
        # self.label.setObjectName("label")
        # self.label_2 = QtWidgets.QLabel(Dialog)
        # self.label_2.setGeometry(QtCore.QRect(160, 90, 55, 18))
        # self.label_2.setObjectName("label_2")
        # self.label_3 = QtWidgets.QLabel(Dialog)
        # self.label_3.setGeometry(QtCore.QRect(300, 90, 55, 18))
        # self.label_3.setObjectName("label_3")
        # self.label_4 = QtWidgets.QLabel(Dialog)
        # self.label_4.setGeometry(QtCore.QRect(90, 210, 55, 18))
        # self.label_4.setObjectName("label_4")
        # self.label_5 = QtWidgets.QLabel(Dialog)
        # self.label_5.setGeometry(QtCore.QRect(250, 210, 55, 18))
        # self.label_5.setObjectName("label_5")
